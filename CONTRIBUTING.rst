...
Welcome to ``pythontest`` contributor's guide.
...
If you experience bugs or general issues with ``pythontest``, please have a look
...
You can help improve ``pythontest`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pythontest`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pythontest``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pythontest python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pythontest.git
    cd pythontest
...
#. Install |pre-commit|_::
   ...
   ``pythontest`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pythontest
.. _issue tracker: https://github.com/<USERNAME>/pythontest/issues
.. <-- end -->
